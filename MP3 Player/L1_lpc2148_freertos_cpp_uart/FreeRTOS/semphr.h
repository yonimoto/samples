...
#define SEMAPHORE_SECTION(SemHandle,blockTime)	for(signed portBASE_TYPE lockTaken = xSemaphoreTake(SemHandle, blockTime); \
													lockTaken == pdTRUE; xSemaphoreGive(SemHandle), lockTaken = pdFALSE)
