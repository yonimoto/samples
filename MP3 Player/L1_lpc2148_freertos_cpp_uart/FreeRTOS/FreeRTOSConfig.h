...
#define configMAX_TASK_NAME_LEN				8	/* Maximum characters to describe a task */
#define configUSE_TRACE_FACILITY			1	/* This is for task traces, usually run-time status is better option */
